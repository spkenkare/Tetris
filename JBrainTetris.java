...
public class JBrainTetris extends JComponent {
     ...
     */
    public static void createGUI(JBrainTetris tetris) {
        JFrame frame = new JFrame("Tetris 2016");
    ...
    JBrainTetris() {
        ...
        timer = new javax.swing.Timer(DELAY, new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                	assignment.Board.Action a = brain.nextMove(board);
                	if(a==Board.Action.COUNTERCLOCKWISE) {
                		tick(a);
